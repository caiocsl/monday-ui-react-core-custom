...
import { LabelKind } from "../Label/LabelConstants";
  ...
  (
    ...
    const renderDay = useCallback(
      (day: Moment) => {
        ...
        const labelRender = parseInt(day.format("D")) % 2 === 0 ? <Label id={day.format("YYYY-MM-DD")} text={"00:00:" + day.format('DD')} /> : <Label id={day.format("YYYY-MM-DD")} text="00:00:00" kind={LabelKind.LINE} />;
